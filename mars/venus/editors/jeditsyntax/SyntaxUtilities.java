...
public class SyntaxUtilities {
    ...
    public static SyntaxStyle[] getDefaultSyntaxStyles() {
        ...
        styles[Token.EDITOR_FG] = new SyntaxStyle(new Color(0, 0, 0), false, false);
    ...
    public static SyntaxStyle[] getCurrentSyntaxStyles() {
        ...
        styles[Token.EDITOR_FG] = Globals.getSettings().getEditorSyntaxStyleByPosition(Token.EDITOR_FG);
